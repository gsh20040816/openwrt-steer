...
if "PKG_VERSION:=0.5.0_alpha3" not in makefile or "PKG_RELEASE:=1" not in makefile:
    fail("steer package version must be the 0.5.0_alpha3-r1 prerelease")
if "PKG_VERSION:=0.5.0_alpha3" not in luci_makefile or "PKG_RELEASE:=1" not in luci_makefile:
    fail("LuCI packages must use the 0.5.0_alpha3-r1 prerelease")
