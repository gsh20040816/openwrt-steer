...
if "PKG_VERSION:=0.9.0_alpha1\n" not in makefile or "PKG_RELEASE:=1\n" not in makefile:
	fail("steer package version must be the APK-safe 0.9.0_alpha1-r1 prerelease")
if "PKG_VERSION:=0.9.0_alpha1\n" not in luci_makefile or "PKG_RELEASE:=1\n" not in luci_makefile:
	fail("LuCI packages must use the APK-safe 0.9.0_alpha1-r1 prerelease")
