...
require(macos_content, "collectionDragPreview(item)", "macOS explicit whole-row drag preview")
require(macos_content, "previewDrag(over:)", "macOS live row-yield drag preview")
