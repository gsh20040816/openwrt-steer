...
| 包 | 版本 | 所有内容 |
|---|---|---|
| `steer` | `0.7.0-alpha.1-r1` | 控制器、默认 UCI、procd init、完整只读 SRS seed |
| `luci-app-steer` | `0.7.0-alpha.1-r1` | LuCI 页面、ucode RPC、ACL |
| `luci-i18n-steer-zh-cn` | `0.7.0-alpha.1-r1` | 简体中文翻译 |
